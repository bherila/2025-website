...
class FileForTaxDocument extends Model
{
    ...
    public const FORM_TYPES = ['w2', 'w2c', '1099_int', '1099_int_c', '1099_div', '1099_div_c', '1099_misc', 'k1', '1116'];

    public const W2_FORM_TYPES = ['w2', 'w2c'];

    public const ACCOUNT_FORM_TYPES = ['1099_int', '1099_int_c', '1099_div', '1099_div_c', '1099_misc', 'k1', '1116'];
