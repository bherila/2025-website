...
class Form1040FactsBuilder extends TaxPreviewFactBuilder
{
    ...
    /**
     * Round a value to whole dollars for IRS whole-dollar reporting.
     *
     * Per IRS Form 1040 instructions: amounts can be reported in whole dollars by
     * dropping cents under 50 and rounding cents from 50 to 99 up to the next
     * dollar. When applying whole-dollar rounding, each constituent input must
     * be rounded BEFORE summing into a derived line — not after.
     */
