...
class BrokerWashSaleTreatmentNormalizer
{
    ...
    public function normalizeTreatment(mixed $value): string
    {
        ...
        return match ($normalized) {
            ...
            'gain_loss_already_reflects_wash_sales_in_basis',
            'included_in_basis',
            ...
            'net',
            'net_gain_loss_already_includes_wash_sale_column',
            'net_of_wash_sale',
            'net_of_wash_sales',
            ...
            'no_wash_sale',
            'no_wash_sale_amount',
            'no_wash_sale_amount_in_source_summary',
            'no_wash_sales',
