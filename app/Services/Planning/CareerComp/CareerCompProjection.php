 ...
 * - jobs:list{id:string,name:string,isCurrent:bool,annual:list{year:int,salary:float,bonus:float,vestedLiquidEquity:float,shareSaleProceeds:float,exerciseOutlay:float,freeCashFlow:float},liquidity:{low:list{year:int,cumulativeValue:float},medium:list{year:int,cumulativeValue:float},high:list{year:int,cumulativeValue:float}},paperEquity:{scenarios:list{id:string,label:string,outcome:'low'|'medium'|'high',points:list{year:int,stage:string|null,preferredPostMoneyValuation:float,capitalDilutionPct:float,employeePoolDilutionPct:float,dilutedOwnershipPct:float,commonFmv:float,grossOwnershipValue:float,grossCommonValue:float,commonIntrinsicValue:float,exerciseCost:float,netPaperValue:float,cumulativeNetPaperValue:float,liquidityEvent:bool},totalNetPaperValue:float},totalsByOutcome:{low:float,medium:float,high:float}},vesting:list{grantId:string,type:'rsu'|'iso'|'nso',year:int,vestedShares:float,exercisableShares:float,source?:string},lifetime:{totalCashComp:float,totalEquityValue:{low:float,medium:float,high:float},totalPaperEquityValue:{low:float,medium:float,high:float},totalValue:{low:float,medium:float,high:float},totalPaperValue:{low:float,medium:float,high:float}},afterTax?:{annual:list{year:int,taxableCompIncome:float,nsoOrdinaryIncome:float,isoAmtPreference:float,equitySaleProceeds:float,estimatedRegularTax:float,estimatedAmt:float,totalEstimatedTax:float,freeCashFlow:float,sourceIds:list<string>},lifetime:{taxableCompIncome:float,nsoOrdinaryIncome:float,isoAmtPreference:float,equitySaleProceeds:float,estimatedRegularTax:float,estimatedAmt:float,totalEstimatedTax:float,freeCashFlow:float,totalValue:{low:float,medium:float,high:float}}}}
