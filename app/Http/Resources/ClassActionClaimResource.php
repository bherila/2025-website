...
class ClassActionClaimResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'claim_submitted_on' => $this->dateString($claim->claim_submitted_on),
            'claim_deadline' => $this->dateString($claim->claim_deadline),
            'administrator' => $claim->administrator,
            'defendant' => $claim->defendant,
            'final_approval_hearing_on' => $this->dateString($claim->final_approval_hearing_on),
            'expected_payment_amount' => $claim->expected_payment_amount !== null ? (float) $claim->expected_payment_amount : null,
            'expected_payment_on' => $this->dateString($claim->expected_payment_on),
            'actual_payment_amount' => $claim->actual_payment_amount !== null ? (float) $claim->actual_payment_amount : null,
