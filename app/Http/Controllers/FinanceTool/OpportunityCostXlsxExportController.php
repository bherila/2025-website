...
class OpportunityCostXlsxExportController extends Controller
{
    public function __construct(
        private readonly OpportunityCostCalculator $calculator,
        private readonly OpportunityCostWorkbookBuilder $workbookBuilder,
    ) {}
    ...
    public function export(Request $request): Response
    {
        ...
        $projection = $this->calculator
            ->project(OpportunityCostInputs::fromArray($validated['inputs']))
            ->toArray();
        ...
        $filename = preg_replace('/[^A-Za-z0-9._-]/', '-', (string) $workbook['filename']) ?: 'opportunity-cost.xlsx';
