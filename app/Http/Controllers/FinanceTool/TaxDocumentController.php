...
Return ONLY a valid JSON array. Do not use markdown or code fences. Each array item must contain account_identifier, account_name, form_type, tax_year, and parsed_data. For 1099-B entries, include parsed_data.wash_sale_treatment using one of gross_of_wash_sales, already_reflected_in_cost_basis, already_net_of_wash_sales, no_wash_sale_amount, or unknown. Include parsed_data.transactions as an array of sale lots with symbol, description, cusip, quantity, purchase_date, sale_date, proceeds, cost_basis, wash_sale_disallowed, wash_sale_treatment, realized_gain_loss, is_short_term, form_8949_box, is_covered, and additional_info. If the broker statement includes supplemental details not reported to the IRS, put them under parsed_data.supplemental_statement using account_fees_total/account_fees, margin_interest_paid_total/margin_interest_paid, and short_dividends_total/short_dividends rows.
