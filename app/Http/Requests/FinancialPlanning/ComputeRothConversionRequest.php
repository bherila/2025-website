...
class ComputeRothConversionRequest extends FormRequest
{
    ...
    public static function scenarioRules(?string $filingStatus = null, mixed $currentYearValue = null): array
    {
        ...
        return [
            ...
            'inputs.expenses' => ['nullable', 'array'],
            'inputs.expenses.propertyTax' => ['nullable', 'numeric', 'min:0', 'max:100000000'],
            'inputs.expenses.medicalExpense' => ['nullable', 'numeric', 'min:0', 'max:100000000'],
            'inputs.expenses.otherNondeductible' => ['nullable', 'numeric', 'min:0', 'max:100000000'],
            'inputs.expenses.caProp13PropertyTaxLimit' => ['nullable', 'boolean'],
