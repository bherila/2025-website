...
- **"How do I debug Schedule 1, Schedule B, or Form 4952 source lines from the backend?"** — use `php artisan finance:tax-preview-facts --year=YYYY --slice=scheduleB --format=toon` and see [tax-system.md § Backend Tax Facts](tax-system.md#backend-tax-facts).
