...
| RSU GenAI import | [rsu.md](rsu.md#genai-pdf-import) | `resources/js/components/rsu/RsuImportModal.tsx` |
...
- **"How do I debug Schedule A/E, Form 1116/4952/8960, Schedule D/Form 8949, or Schedule 1/B source lines from the backend?"** — use `php artisan finance:tax-preview-facts --year=YYYY --slice=scheduleE --format=toon` and see [tax-system.md § Backend Tax Facts](tax-system.md#backend-tax-facts).
