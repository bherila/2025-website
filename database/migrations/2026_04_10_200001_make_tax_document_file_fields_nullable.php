...
return new class extends Migration
{
  ...
  `created_at`, `updated_at`, `deleted_at`';
    ...
    /**
     * Makes original_filename, stored_filename, and s3_path nullable.
     * Records created from LLM parsing output do not need their own file reference.
     *
     ...
     * Note: form_type is plain TEXT with no CHECK constraint as of the preceding migration.
     */
    private function rebuildTable(bool $nullable): void
    {
        $notNull = $nullable ? '' : "NOT NULL DEFAULT ''";
