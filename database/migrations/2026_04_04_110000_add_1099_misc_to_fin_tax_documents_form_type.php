...
return new class extends Migration
{
  ...
  `file_hash`, `uploaded_by_user_id`, `notes`, `is_reconciled`, `genai_job_id`,
  `genai_status`, `parsed_data`, `is_confirmed`, `download_history`,
  ...
  FOREIGN KEY(`user_id`) REFERENCES `users`(`id`) ON DELETE CASCADE
    ...
    public function down(): void
    {
        ...
        if ($driver === 'sqlite') {
            $this->rebuildTable("'w2', 'w2c', '1099_int', '1099_int_c', '1099_div', '1099_div_c'");
            $this->copyAndDrop("`form_type` != '1099_misc'");
        }
    }
};
