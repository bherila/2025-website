...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Adds interest, ordinary_dividend, qualified_dividend, other_ordinary_income
     * to the tax_characteristic ENUM.
