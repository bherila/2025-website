...
return new class extends Migration
{
  ...
  FOREIGN KEY(`user_id`) REFERENCES `users`(`id`) ON DELETE CASCADE
    ...
    /**
     * Adds '1099_nec' and '1099_r' to the fin_tax_documents.form_type constraint.
     * Form 1099-NEC (nonemployee compensation) and Form 1099-R (retirement distributions)
     * documents can now be uploaded and reviewed.
     *
    ...
    public function up(): void
    {
        ...
        if ($driver === 'mysql') {
            DB::statement("ALTER TABLE fin_tax_documents MODIFY COLUMN form_type ENUM('w2','w2c','1099_int','1099_int_c','1099_div','1099_div_c','1099_misc','1099_nec','1099_r','k1','1116') NOT NULL");
    ...
    public function down(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            $this->copyDropRenameAndIndex("`form_type` NOT IN ('1099_nec', '1099_r')");
        }
    }
};
