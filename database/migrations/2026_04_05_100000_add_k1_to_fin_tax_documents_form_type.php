...
return new class extends Migration
{
  ...
  FOREIGN KEY(`user_id`) REFERENCES `users`(`id`) ON DELETE CASCADE
    ...
    /**
     * Adds 'k1' to the fin_tax_documents.form_type constraint.
     * K-1 / K-3 forms are issued by partnerships, S-corporations, estates, and trusts
     * to report each partner's/shareholder's/beneficiary's share of income, deductions, and credits.
     *
