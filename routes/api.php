...
Route::middleware(['web', 'auth'])->post('/rsu/backfill-vest-prices', [FinanceRsuController::class, 'backfillVestPrices']);
Route::middleware(['web', 'auth'])->get('/rsu/settlements', [FinanceRsuController::class, 'settlements']);
Route::middleware(['web', 'auth'])->post('/rsu/settlements/suggest', [FinanceRsuController::class, 'suggestSettlements']);
Route::middleware(['web', 'auth'])->post('/rsu/settlements/{settlement}/confirm', [FinanceRsuController::class, 'confirmSettlement']);
Route::middleware(['web', 'auth'])->put('/rsu/settlements/{settlement}', [FinanceRsuController::class, 'updateSettlement']);
Route::middleware(['web', 'auth'])->post('/rsu/settlements/{settlement}/ignore', [FinanceRsuController::class, 'ignoreSettlement']);
Route::middleware(['web', 'auth'])->get('/rsu/settlements/{settlement}/links', [FinanceRsuController::class, 'settlementLinks']);
Route::middleware(['web', 'auth'])->get('/rsu/settlements/{settlement}/candidates', [FinanceRsuController::class, 'settlementCandidates']);
Route::middleware(['web', 'auth'])->post('/rsu/settlements/{settlement}/links', [FinanceRsuController::class, 'createSettlementLink']);
Route::middleware(['web', 'auth'])->delete('/rsu/links/{link}', [FinanceRsuController::class, 'deleteRsuLink']);
Route::middleware(['web', 'auth'])->get('/rsu/tax-projection', [FinanceRsuController::class, 'taxProjection']);
Route::middleware(['web', 'auth'])->get('/finance/transactions/{transaction}/rsu-links', [FinanceRsuController::class, 'transactionRsuLinks']);
Route::middleware(['web', 'auth'])->get('/payslips/{payslip}/rsu-links', [FinanceRsuController::class, 'payslipRsuLinks']);
...
Route::middleware(['web', 'auth'])->get('/payslips/prompt', [FinancePayslipController::class, 'getPrompt']);
