...
/**
 * Build URL for fees page
 */
export function feesUrl(accountId: number, options: RouteOptions = {}): string {
  return `/finance/account/${accountId}/fees${buildQueryString(options.year)}`
}
