...
export interface TaxCharacteristicMeta {
  label: string
  category: 'sch_c_income' | 'sch_c_expense' | 'sch_c_home_office' | 'other'
  entityTypes: string[] // e.g. ['sch_c'], or [] for none
}
...
export const CATEGORY_ORDER = ['sch_c_income', 'sch_c_expense', 'sch_c_home_office', 'other'] as const
