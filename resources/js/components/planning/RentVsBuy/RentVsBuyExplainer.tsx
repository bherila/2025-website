    ...
    <Card>
      ...
      <CardContent>
        <ul className="text-muted-foreground grid gap-3 text-sm leading-6">
          ...
          <li>Closing costs are treated as upfront economic cost. Selling costs are only applied when estimating sellable equity at each year-end.</li>
          <li>Homeowners insurance, renter&apos;s insurance, and HOA fees stay nominal unless you change them. Property tax and maintenance scale with the modeled home value.</li>
