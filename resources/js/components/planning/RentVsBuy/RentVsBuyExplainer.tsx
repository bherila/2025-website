    ...
    <Card>
      ...
      <CardContent>
        <ul className="text-muted-foreground grid gap-3 text-sm leading-6">
          ...
          <li>Homeowners insurance, renter&apos;s insurance, and HOA fees stay nominal unless you change them. Property tax and maintenance scale with the modeled assessed or market value.</li>
