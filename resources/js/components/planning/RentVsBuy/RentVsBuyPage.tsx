...
const QUERY_KEYS: Record<keyof RentVsBuyInputs, string> = {
  ...
  hoaGrowthPercent: 'hoa_grow',
  homeownersInsuranceAnnual: 'home_ins',
  homeownersInsuranceGrowthPercent: 'home_ins_grow',
  ...
  rentersInsuranceGrowthPercent: 'rent_ins_grow',
...
function parseInputs(search: string): RentVsBuyInputs {
  ...
  return {
    ...
    hoaGrowthPercent: parseNumber(searchParams, 'hoaGrowthPercent'),
    homeownersInsuranceAnnual: parseNumber(searchParams, 'homeownersInsuranceAnnual'),
    homeownersInsuranceGrowthPercent: parseNumber(searchParams, 'homeownersInsuranceGrowthPercent'),
    ...
    rentersInsuranceGrowthPercent: parseNumber(searchParams, 'rentersInsuranceGrowthPercent'),
