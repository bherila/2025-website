 ...
 * tests/Fixtures/opportunity-cost/golden-projection.json, asserted in goldenFixture.test.ts.
 */
export const sampleOpportunityCostProjection: OpportunityCostProjection = {
  startYear: 2026,
  horizonYears: 3,
