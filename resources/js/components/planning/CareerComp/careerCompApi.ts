...
export function saveCareerComparison(inputs: CareerCompInputs, shareIncludesCurrent = true, title?: string): Promise<SaveCareerCompResponse> {
  return fetchWrapper.post('/api/financial-planning/career-comparison/workflows', { inputs, shareIncludesCurrent, title }) as Promise<SaveCareerCompResponse>
}

export function updateCareerComparison(id: number, inputs: CareerCompInputs, shareIncludesCurrent = true, title?: string): Promise<SaveCareerCompResponse> {
  return fetchWrapper.patch(`/api/financial-planning/career-comparison/workflows/${id}`, { inputs, shareIncludesCurrent, title }) as Promise<SaveCareerCompResponse>
}
