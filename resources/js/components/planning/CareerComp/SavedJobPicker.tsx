...
import type { CareerCompInputs, JobSpec, SavedCareerJob } from './types'
...
interface SavedJobPickerProps {
  ...
  onApply: (inputs: CareerCompInputs) => void
}
...
function slotOptions(inputs: CareerCompInputs): SlotOption[] {
  return [
...
function applyToSlot(inputs: CareerCompInputs, target: string, spec: JobSpec): CareerCompInputs {
