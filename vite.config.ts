  ...
  plugins: [
    ...
    laravel({
      input: [
        ...
        'resources/js/phr/patients/index.tsx',
        'resources/js/phr/patients-manage/index.tsx',
        'resources/js/phr/summary/index.tsx',
        'resources/js/phr/labs/index.tsx',
        'resources/js/phr/vitals/index.tsx',
        'resources/js/phr/imaging/index.tsx',
        'resources/js/phr/office-visits/index.tsx',
        'resources/js/phr/medications/index.tsx',
        'resources/js/phr/conditions/index.tsx',
        'resources/js/phr/procedures/index.tsx',
        'resources/js/phr/immunizations/index.tsx',
        'resources/js/phr/allergies/index.tsx',
        'resources/js/phr/documents/index.tsx',
        'resources/js/phr/access/index.tsx',
